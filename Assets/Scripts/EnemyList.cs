...
public class EnemyList : ScriptableObject
{
  ...
  public Dictionary<string, int> multiplyerCap = new Dictionary<string, int> { { "SmallShark", 5 }, { "GoldFish", 20 }, { "AngelFish", 15 }, { "Jelly", 8 }, { "Bird", 8 }, { "Starfish", 1 }, { "SharkNet", 50 }, { "Squid", 5 }, { "CoinFish", 0 }, { "BigShark", 10 } };
